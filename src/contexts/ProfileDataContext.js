...
export const ProfileDataProvider = ({ children }) => {
    ...
    // We won’t use the destructured popularProfiles because, eventually, we’ll pass the entire profileData object as the value prop in the ProfileDataContext.Provider. 
